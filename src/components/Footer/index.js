        ...
        <div className='footer'>
            <div className='row'>
                <div className='branding'>
                    <img src="/logo.jpg" alt="Logo" className='footerLogo' />
                ...
                <div className='footer-services'>
                    <h1 className='footer-headline'>Products</h1>
                    <div className='row'>
                        <div className='left'>
                            <ul>
                                <li>Ball pen</li>
                ...
                <div className='contact footer-contact'>
                    ...
                    <div className='row'>
                    <ul>
                        <a href="tel:+919987423546" className="no-underline-link"><li>+91 9867674340</li></a>
                        <li>{MailComponent()}</li>
                    </ul>
